...
// Import utilities
const { scheduleCleanup } = require('./src/utils/fileCleanup');
const { performanceMonitor, setupMongooseQueryMonitoring } = require('./src/middleware/performanceMonitor');
...
// Setup query monitoring (if enabled)
setupMongooseQueryMonitoring(mongoose);
...
app.listen(PORT, () => {
    ...
    // Schedule automatic file cleanup (every 6 hours, delete files older than 24 hours)
